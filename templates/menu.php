...
<div class="container">
    <div class="sidebar">
        <div class="sidebar-content">
            ...
            <ul>
                <li id="home"><img src="static/img/home.png"><a>Головна</a></li>
                <li id="profile"><img src="static/img/people.png"><a>Профіль</a></li>
                <li id="make-post"><img src="static/img/mail.png"><a>Зробити Пост</a></li>
                <li id="user-info">
                    <div class="item">
